            ...
            <div className="container">
                <div className="grid gap-y-10 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-5 lg:py-[100px]">
                    <div className="relative">
                        <img src="/assets/images/logo.png" alt="Codebeans" className="h-7" />
                    ...
                    <div>
                        <ul className="flex flex-col gap-3 font-bold">
                            ...
                            <li>552, Tonk Road, Jaipur, Rajasthan, India - 302018</li>
                            <li>
                                <a href="tel:+(91) 9950090909" className="inline-block transition hover:scale-110 hover:text-secondary">
                                    +(91) 9950090909
                                </a>
                            </li>
                            <li>
                             <a href="mailto:office@codebeans.net" className="inline-block transition hover:scale-110 hover:text-secondary">
                                    office@codebeans.net
                                </a>
							</li>
