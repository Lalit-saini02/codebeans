        ...
        <header className={`sticky top-0 z-50 bg-black/10 transition duration-300 ${props.className}`}>
            <div className="container">
                <div className="flex items-center justify-between py-5 lg:py-0">
                    <Link to="/">
                        <img src="/assets/images/codebeans-logo.png" alt="logo" className="h-8" />
                    </Link>
                            ...
                            <ul onClick={() => toggleMenu()}>
                                ...
                                {/* <li className="group relative" onClick={(e) => e.stopPropagation()}>
                                    ...
                                    <div className="submenu" onClick={() => toggleMenu()}>
                                        ...
                                        <a href="#">
                                            Online Courses
                                            <span className="ml-1 whitespace-nowrap rounded bg-secondary px-2 py-1 text-[9px] font-bold uppercase text-white">
                                                Coming Soon
                                            </span>
                                        </a>
                                        <a href="#">
                                ...
                                <li>
                                    <NavLink to="/portfolio" className={location.pathname === '/portfolio-detail' ? 'active' : ''}>
                                        Portfolio
                                    </NavLink>
                                </li>
                                <li>
