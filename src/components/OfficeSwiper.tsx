                                    ...
                                    <div className="py-10 px-5 sm:px-8">
                                        ...
                                        <ul className="space-y-4 pt-10">
                                            <li className="flex gap-3">
                                                ...
                                                <div className="text-sm font-bold sm:text-lg">552, Tonk Road, Jaipur, Rajasthan, India - 302018</div>
                                            </li>
                                            <li className="flex items-center gap-3">
                                                ...
                                                <a href="tel:+919950090909" className="text-sm font-bold hover:text-secondary sm:text-lg">
                                                    +91 9950090909
                                                </a>
                                            </li>
                                            <li className="flex items-center gap-3">
                                                ...
                                                <a href="mailto:office@codebeans.net" className="text-sm font-bold hover:text-secondary sm:text-lg">
