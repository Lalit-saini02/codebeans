...
const Career = () => {
    document.title = 'Career | Web App Development Company';
    ...
    return (
        <div>
                        ...
                        <div className="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                            <div className="heading relative mb-0 text-center ltr:md:text-left rtl:md:text-right">
                                ...
                                <h4 className="!text-white">
                                    Join our team at <span className="text-primary">Codebeans</span>
                                </h4>
                            </div>
            ...
            <section className="relative pt-14 lg:pb-48 lg:pt-[100px]">
                <div className="container relative z-[1]">
                    <div className="text-center lg:w-1/2 ltr:lg:text-left rtl:lg:text-right">
                        <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right xl:w-[93%]">
                            <h6>Who are we?</h6>
                            <h4>We thrive to help our clients have global impact</h4>
                        </div>
                        <p className="pb-10 text-lg font-semibold w-[85%] leading-[30px]">
                        ...
                        <a href="#openposition" className="btn capitalize text-white">
                            Join Our Team
                        </a>
                    </div>
                </div>
                    ...
                    <div className="grid items-center gap-8 md:grid-cols-3 lg:grid-cols-2 xl:items-start">
                        <div className="order-2 md:order-1 md:col-span-2 lg:col-auto">
                            ...
                            <div className="text-center font-semibold ltr:md:text-left rtl:md:text-right">
                                ...
                                <Link to="#open-position" className="btn mt-10 capitalize text-white">
                                    Open Positions
                                </Link>
                            </div>
                        </div>
            ...
            <section className="bg-gradient-to-t from-white/[54%] to-transparent py-14 dark:bg-none lg:py-[100px]">
                <div className="container">
                    <div className="heading text-center">
                        ...
                        <h4>Great benefits of working at Codebeans</h4>
                    </div>
            ...
            <section className="py-14 lg:py-[100px]" id="openposition">
                <div className="container">
                    <div className="heading text-center">
