...
const Crypto = (props: any) => {
    document.title = 'Crypto | Web App Development Company';
                ...
                <div className="container">
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="rounded-[18px] bg-white p-4 dark:bg-black" data-aos="fade-up" data-aos-duration="1000">
                            <div className="flex justify-between">
                                <div className="flex items-center gap-2.5">
                                    <Link to="#" className="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#F7931A]">
                        ...
                        <div className="rounded-[18px] bg-white p-4 dark:bg-black" data-aos="fade-up" data-aos-duration="1000">
                            <div className="flex justify-between">
                                <div className="flex items-center gap-2.5">
                                    <Link to="#" className="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#345d9d]">
                        ...
                        <div className="rounded-[18px] bg-white p-4 dark:bg-black" data-aos="fade-up" data-aos-duration="1000">
                            <div className="flex justify-between">
                                <div className="flex items-center gap-2.5">
                                    <Link to="#" className="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#F3BA2F]">
                        ...
                        <div className="rounded-[18px] bg-white p-4 dark:bg-black" data-aos="fade-up" data-aos-duration="1000">
                            <div className="flex justify-between">
                                <div className="flex items-center gap-2.5">
                                    <Link to="#" className="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#53ae94]">
