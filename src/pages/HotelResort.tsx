...
const HotelResort = () => {
    document.title = 'Hotel & Resort | Web App Development Company';
    ...
    const css = `input[type='date']::-webkit-calendar-picker-indicator {
        filter: invert(1);
    }`;
        ...
        <div>
            <section className="hotel-resort-banner relative">
                ...
                <div className="absolute inset-x-0 bottom-0 z-[1] bg-black/50">
                    <div className="container">
                        <div className="grid grid-cols-2 gap-4 py-8 sm:grid-cols-4 xl:grid-cols-5" data-aos="fade-up" data-aos-duration="1000">
            ...
            <section className="relative py-12 lg:py-24">
                ...
                <div className="container relative">
                    ...
                    <div className="text-center">
                        <Link to="/services" className="btn mt-7 bg-secondary py-[18px] px-8 text-white">
                            More Services
                        </Link>
                    </div>
                </div>
                ...
                <div className="container">
                    ...
                    >
                        <div className="group">
                            ...
                            <h2 className="mt-6">
                                <Link to="#" className="text-2xl font-bold text-black hover:text-primary dark:text-white">
                                    Paris Rail Day Trip
                                </Link>
                            </h2>
                            ...
                            <div className="flex-1 text-center ltr:md:text-left rtl:md:text-right">
                                <div className="heading mb-8">
                                    ...
                                    <h6 className="mt-[18px] !font-semibold !text-gray">
                                        Our objective at Codebeans is to bring together our visitor's societies and spirits with our own, communicating enthusiasm
                                ...
                                <div className="flex justify-center sm:gap-16 md:justify-start md:gap-10">
                                    <ul className="space-y-3">
                                        <li className="flex items-center gap-3">
                                            ...
                                            <Link to="#" className="text-lg font-semibold text-white duration-200 hover:text-primary">
                                                Spa/gym
                                            </Link>
                                        </li>
                                        <li className="flex items-center gap-3">
