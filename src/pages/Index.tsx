...
const index = (props: any) => {
    document.title = 'Web App Development Company';
                ...
                <div className="relative">
                    ...
                    <div className="container">
                        <div className="relative bg-[url(/assets/images/world-map.png)] bg-cover bg-top bg-no-repeat pt-14 pb-0 lg:pt-20 lg:pb-60 xl:pt-36">
                            <div className="relative z-[1] text-center text-white lg:w-3/5 ltr:lg:text-left rtl:lg:text-right xl:w-1/2" data-aos="fade-right" data-aos-duration="2000">
                                <h2 className="text-4xl font-extrabold leading-normal sm:text-5xl lg:text-[62px] lg:leading-[90px] ">
                                    <span className="italic text-primary">Web</span> and <span className="italic text-primary">Mobile</span> App Development<br></br><span className="italic text-secondary">Company</span>
                                </h2>
                                <p className="my-8 text-lg lg:w-[90%] ">
                                    Special case is a custom software development company with expert software engineers, developers, and designers. Talk to us to develop, design, renovate, integrate, or test your software.
                                </p>
                                <Link to="/about-us" className="btn mx-auto mt-2 block w-fit bg-white lg:mx-0 lg:rtl:ml-auto">
                                    Request For Demo
                                </Link>
                            </div>
                            <div
                    ...
                    <div className="grid gap-6 mb-5 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <Link
                                    to="/services-detailservmag"
                                    className="my-8 inline-block text-[22px] font-extrabold text-black dark:text-white dark:group-hover:text-black"
                                >
                                    Server Maintenance
                                </Link>
                                <p className="mb-10 text-lg font-semibold transition line-clamp-3 dark:group-hover:text-black">
                                    Enjoy 24/7 server availability monitoring, performance monitoring, security
                                </p>
                                <Link
                                    to="/services-detailservmag"
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black rtl:rotate-180 dark:bg-gray-dark"
                    ...
                    <div className="grid gap-6 mb-5 sm:grid-cols-2 lg:grid-cols-3">
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                <div
                                    className="flex h-14 w-14 items-center justify-center rounded-full bg-secondary transition group-hover:bg-black"
                                    style={{
                                        boxShadow: '0px 15px 30px rgba(180, 118, 229, 0.4)', fontSize: "22px", color: "white"
                                    }}
                                >
                                    <FaTools />
                                </div>
                                <Link
                                    to="/services-detailinegration"
                                    className="my-8 inline-block text-[22px] font-extrabold text-black dark:text-white dark:group-hover:text-black"
                                >
                                    Integration
                                </Link>
                                <p className="mb-10 text-lg font-semibold transition line-clamp-3 dark:group-hover:text-black">
                                    Access API integration services for SaaS, web applications & websites and ongoing API integration support & quality assurance.
                                </p>
                                <Link
                                    to="/services-detailinegration"
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black rtl:rotate-180 dark:bg-gray-dark"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <Link
                                    to="/services-detailecon"
                                    className="my-8 inline-block text-[22px] font-extrabold text-black dark:text-white dark:group-hover:text-black"
                                >
                                    Ecommerce Development
                                </Link>
                                <p className="mb-10 text-lg font-semibold transition line-clamp-3 dark:group-hover:text-black">
                                    E-Сommerce development services based on popular solutions: Shopify, OpenCart, WooCommerce and Bitrix.
                                </p>
                                <Link
                                    to="/services-detailecon"
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black rtl:rotate-180 dark:bg-gray-dark"
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <Link
                                    to="services-detailmobile"
                                    className="my-8 inline-block text-[22px] font-extrabold text-black dark:text-white dark:group-hover:text-black"
                                >
                                    Mobile App Development
                                </Link>
                                <p className="mb-10 text-lg font-semibold transition line-clamp-3 dark:group-hover:text-black">
                                    Contacting a mobile app development company and creating a mobile app is a proven way to increase user loyalty.
                                </p>
                                <Link
                                    to="services-detailmobile"
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black rtl:rotate-180 dark:bg-gray-dark"
                    ...
                    <div className="projects grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                        <div className={`project ${activeTab === 'all' || activeTab === 'web' ? 'block' : 'hidden'}`}>
                            <div className="relative rounded-3xl border border-transparent bg-white drop-shadow-[5px_10px_80px_rgba(119,128,161,0.15)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark dark:drop-shadow-none">
                                <Link to="/portfolio-detail" className="absolute top-0 left-0 h-full w-full"></Link>
                        ...
                        <div className="flex flex-col group rounded-3xl border-2 border-primary bg-white p-6 px-4 transition hover:bg-primary hover:drop-shadow-[-10px_30px_70px_rgba(40,38,77,0.25)] dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.01] dark:to-transparent dark:drop-shadow-none dark:hover:border-gray-dark dark:hover:bg-gray-dark sm:px-6" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div className="mt-auto border-t-2 border-[#BBC0D0]/50 pt-7">
                                <div className="mb-3 flex flex-col items-center justify-center sm:flex-row sm:justify-between">
                                    ...
                                    <Link to="#" className="btn text-xl text-white group-hover:bg-white group-hover:text-primary dark:text-black xl:w-44">
                                        $39.99
                        ...
                        <div className="flex flex-col group rounded-3xl border-2 border-black bg-white p-6 px-4 transition hover:bg-black hover:drop-shadow-[-10px_30px_70px_rgba(40,38,77,0.25)] dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.01] dark:to-transparent dark:drop-shadow-none dark:hover:border-gray-dark dark:hover:bg-gray-dark sm:px-6" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div className="mt-auto border-t-2 border-[#BBC0D0]/50 pt-7">
                                <div className="mb-3 flex flex-col items-center justify-center sm:flex-row sm:justify-between">
                                    ...
                                    <Link to="#" className="btn bg-black text-xl text-white group-hover:bg-white group-hover:text-black xl:w-44">
                                        $499
                                    </Link>
                                </div>
