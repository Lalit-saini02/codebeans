...
const ModernSaas = () => {
    document.title = 'Modern SAAS | Web App Development Company';
    ...
    const faqs: any = [
        ...
        {
            id: 6,
            question: 'Who else is using Codebeans SaaS tool?',
            answer: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
        },
    ];
                    ...
                    <div className="relative">
                        <div className="pt-14 pb-8 text-center text-white lg:w-3/5 lg:py-20 ltr:lg:text-left rtl:lg:text-right">
                            ...
                            <p className="my-8 text-lg lg:w-3/4">
                                Codebeans is fully equipped with everything you need to build a high performing website for your SaaS.
                            </p>
                            <Link to="" className="btn mx-auto mt-2 block w-fit bg-white lg:mx-0 lg:rtl:ml-auto">
                                Free trial
                            </Link>
                        </div>
                        <div
                    ...
                    <div className="mt-16 grid gap-x-7 gap-y-12 text-lg font-semibold sm:grid-cols-2 lg:grid-cols-3 lg:gap-y-20">
                        ...
                        <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="line-clamp-3">Let’s take a deeper look into what report automation is, why your agency should automate its..</p>
                            </div>
                        </div>
                        <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
            ...
            <section className="py-14 lg:py-20">
                <div className="container">
                    <div className="relative grid items-center gap-y-10 lg:grid-cols-2 lg:gap-4">
                        ...
                        />
                        <div className="ltr:pr-24 rtl:pl-24 sm:ltr:pr-60 sm:rtl:pl-60 lg:ltr:pr-24 lg:rtl:pl-24" data-aos="fade-up" data-aos-duration="1000">
            ...
            <section className="bg-white/50 py-14 dark:bg-white/[0.03] lg:py-20">
                <div className="container">
                    <div className="heading mb-5 text-center">
                        <h6 className="!text-secondary">Drive more lead with Codebeans</h6>
                    ...
                    >
                        <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                            ...
                            <p className="mt-6 text-lg font-semibold">
                                Migrating a legacy system involves taking your old infrastructure and transferring it to the cloud. This does provide potential
                                cost and efficiency benefits. However, it fails to give your application a growth perspective.
                            </p>
                            <Link
                                to="#"
                    ...
                    <div className="grid gap-14 sm:grid-cols-2 lg:grid-cols-3">
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <p className="mt-6 mb-8 text-lg font-semibold line-clamp-4">
                                Design and user experience are among the essential aspects of SaaS. Even if you are just entering the market and no one knows
                                you,
                            </p>
                            <Link to="/services-detail" className="text-lg font-extrabold text-secondary transition hover:text-primary">
                                Read More +
                            </Link>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <Link to="/services-detail" className="text-lg font-extrabold text-primary transition hover:text-secondary">
                                Read More +
                            </Link>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="1000">
