...
const Nft = () => {
    document.title = 'Nft | Web App Development Company';
        ...
        <div>
            ...
            <section className="bg-white px-4 py-8 dark:bg-gray-dark">
                <div className="mx-auto max-w-[1342px]">
                    ...
                    >
                        <SwiperSlide>
                            <Link to="#" className="flex h-16 w-64 items-center justify-center p-2 transition hover:scale-110">
            ...
            <section className="bg-gradient-to-t from-white/[55%] to-transparent py-14 dark:from-white/5 md:py-20">
                <div className="container">
                    ...
                    <div className="mt-8 text-center">
                        <Link to="#" className="btn bg-[#00111f0f] dark:bg-white/5 dark:text-white dark:hover:bg-secondary">
                            see all the drops
                        </Link>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="mb-8 flex flex-col items-center gap-5 md:mb-0 md:flex-row md:items-start md:justify-between">
                        ...
                        <div className="mt-4 flex-none">
                            <Link to="#" className="font-bold text-secondary transition hover:text-primary">
                                View All
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-8 lg:flex-row">
                        <div className="flex-1">
                            ...
                            <div className="text-center lg:ltr:text-left lg:rtl:text-right">
                                <Link to="#" className="btn bg-white px-9">
                                    create
                                </Link>
                            </div>
                        </div>
