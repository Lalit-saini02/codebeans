...
import sample from '../../public/assets/video/vecteezy_fantasy-lights-background-vivid-color-particles-abstract_16627204_989.mp4'

const Portfolio = () => {
    document.title = 'Portfolio | Web App Development Company';
    ...
    return (
        <div>
            <div>
                <div className="bg-[url(/assets/images/inner-page-hero-bg.png)] bg-no-repeat pt-[82px] lg:pt-[106px]">
                ...
                <section className="pt-12 pb-14 md:pb-[100px]">
                    {/* <video className='videoTag h-auto ' style={{ position: "absolute", objectFit: "cover", marginTop: "-36px" }} autoPlay loop muted>
                        <source src={sample} type='video/mp4' />
                    </video> */}
                    <div className="container">
                        <div className="overflow-x-auto" style={{ position: "relative" }}>
                            <ul className="portfolio-filter mx-auto flex w-max gap-7 whitespace-nowrap pb-2.5 font-bold dark:text-white">
                        ...
                        <div className="projects mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <div className={`project ${activeTab === 'all' || activeTab === 'website' ? 'block' : 'hidden'}`}>
                                <div className="relative rounded-3xl border border-transparent bg-white drop-shadow-[5px_10px_80px_rgba(119,128,161,0.15)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark dark:drop-shadow-none hover:scale-[1.06] hover:shadow-[0_0px_16px_1px_black] dark:hover:shadow-[0_0px_13px_3px_white]">
                            ...
                            <div className={`project ${activeTab === 'all' || activeTab === 'website' ? 'block' : 'hidden'}`}>
                                <div className="relative rounded-3xl border border-transparent bg-white drop-shadow-[5px_10px_80px_rgba(119,128,161,0.15)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark hover:scale-[1.06] hover:shadow-[0_0px_16px_1px_black] dark:hover:shadow-[0_0px_13px_3px_white] dark:drop-shadow-none">
                                    <Link to="/portfolio-detail" className="absolute top-0 h-full w-full ltr:left-0 rtl:right-0"></Link>
                            ...
                            <div className={`project ${activeTab === 'all' || activeTab === 'website' ? 'block' : 'hidden'}`}>
                                <div className="relative rounded-3xl border border-transparent bg-white drop-shadow-[5px_10px_80px_rgba(119,128,161,0.15)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark dark:drop-shadow-none hover:shadow-[0_0px_16px_1px_black] dark:hover:shadow-[0_0px_13px_3px_white] hover:scale-[1.06]">
                                    <Link to="/portfolio-detail" className="absolute top-0 h-full w-full ltr:left-0 rtl:right-0"></Link>
