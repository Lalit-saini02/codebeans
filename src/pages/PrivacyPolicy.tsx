...
const Privacypolicy = () => {
    document.title = 'Privacy Policy | Web App Development Company';
                ...
                <div className="container">
                    <div className="pb-12">
                        ...
                        <p className="pb-5 text-lg font-medium">
                            ...
                            Privacy Policy document contains types of information that is collected and recorded by www.codebeans.net and how we use it.
                        </p>
                        <p className="pb-5 text-lg font-medium">
