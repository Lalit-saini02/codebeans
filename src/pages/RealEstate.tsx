...
const RealEstate = () => {
    document.title = 'Real Estate – Tailwind CSS Multipurpose Landing Templates';
                            ...
                            <div className="projects mt-8 grid grid-cols-1 gap-[30px] sm:grid-cols-2 md:grid-cols-3">
                                <div className={`project ${activeTab === 'residentails' ? 'block' : 'hidden'}`}>
                                    ...
                                    <div className="mt-5 flex items-center justify-between">
                                        ...
                                        <Link to="#" className="duration-200 hover:text-[#FF0000]">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <Link to="#" className="group mt-5 flex items-center gap-2.5 text-lg font-bold text-secondary hover:text-primary">
