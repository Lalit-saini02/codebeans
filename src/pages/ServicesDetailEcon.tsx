                    ...
                    <div className="container">
                        <div className="relative items-center py-14 lg:flex lg:py-[100px]">
                            <div className="relative z-[1] text-center text-white lg:w-3/5 ltr:lg:text-left rtl:lg:text-right xl:w-3/5">
                                <h2 className="text-4xl font-black sm:text-5xl sm:leading-[126px] xl:text-[100px]">Ecommerce Development</h2>
                                <p className="my-8 text-xl leading-[40px] text-[#7780A1]">
                                    We do not know everything about everything but one thing we do know for sure - We are proud to say out loud that we really make great web development software.
                                </p>
                            ...
                            >
                                <img src="/assets/images/Econdev.gif" alt="services-detail-phone" className="mx-auto h-full" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-14 lg:py-[100px]">
                <div className="container">
                    <div className="heading text-center  ltr:lg:text-center rtl:lg:text-right">
                        ...
                        <h4>Our Versatile eCommerce Development Expertise</h4>
                    ...
                    <div className="grid gap-10 sm:grid-cols-2 sm:gap-10 lg:grid-cols-3">
                        <div>
                            ...
                            <p className="font-semibold text-center leading-[32px] md:text-lg">
                                <b className='font-exterbold text-black'>E-store Development Experts: </b>
                                Our professional web designers and developers are able to provide top-notch services both in front-end and back-end fields allowing for better performance, faster page load speed and advanced security. We’re also familiar with complicated situations: multi-language, multi-storefront or multi-vendor stores.
                            </p>
                        </div>
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <p className="font-semibold text-center leading-[32px] md:text-lg">
                                <b className='font-exterbold text-black'>Multiple eCommerce Platforms: </b>Our experience is platform-agnostic allowing us to work with multiple ecommerce solutions such as: WooCommerce, Shopify, OpenCart, Bitrix and more. We’re ready to either work on top of open source framework or to use a proprietary commercial solution.
                            </p>
                        </div>
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <p className="font-semibold text-center leading-[32px] md:text-lg">
                                <b className='font-exterbold text-black'>Platform Migration Services: </b>Might you have a migration project with the import of all your product information and orders from one platform to another, our experts are always here to offer strategic advice and help in technical execution. We can always recommend the best solution for your store and draft the migration plan.
                            </p>
                        </div>
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <p className="font-semibold text-center leading-[32px] md:text-lg">
                                <b className='font-exterbold text-black'>Conversion Rate Optimization: </b> One of the assured ways to attract potential clients and have better conversion rates is to have a compelling UI&UX design. We’re always working towards making sure that your clients are having the best experience possible using techniques like usability testing, usecase testing, UI mapping and other tools that help to improve conversion rates.
                            </p>
                        </div>
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <p className="font-semibold text-center leading-[32px] md:text-lg">
                                <b className='font-exterbold text-black'>API-based eCommerce: </b>
                                Basically, APIs are the way that different applications can interact with each other. We’re working with APIs for ecommerce project integrations all the time to ensure that your different third-party apps can exchange information with the ecommerce system.
                            </p>
                        </div>
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            {/* <h4 className="mb-4 text-[22px] font-extrabold text-black dark:text-white">Launch</h4> */}
                            <p className="font-semibold text-center leading-[32px] md:text-lg"><b className='font-exterbold text-black'>Multi-store eCommerce: </b>Our services aren’t just limited to one store per client. We can easily help you with setting up and organizing your second, fifth or tenth store - and connect them into one singular network with specializations based on location, language, currency or any other factor. And all of that is possible within one ecommerce development service provider - SpecialCase.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-14 lg:py-[100px]">
                <div className="container">
                    ...
                    <Marquee className='items-center'
                        ...
                        pauseOnClick={true}
                    >
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/javascript.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/Laravel.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/microsoft.net.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/azure.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/mysql.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/postsql.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/react.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/node.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/angular.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/php.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[20px] w-[70px]'>
                            <img src='assets/images/zoho.png' alt='brand-Logo' />
                        </div>
                    </Marquee>
                </div>
            </section>
...
export default ServicesDetailEcon;