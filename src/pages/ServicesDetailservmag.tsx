    ...
    return (
        <div>
                    ...
                    <div className="container">
                        <div className="relative items-center py-14 lg:flex lg:py-[100px]">
                            <div className="relative z-[1] text-center text-white lg:w-3/5 ltr:lg:text-left rtl:lg:text-right xl:w-3/5">
                                <h2 className="text-4xl font-black sm:text-5xl sm:leading-[126px] xl:text-[70px]">Server Mainteance</h2>
                                <p className="my-8 text-xl leading-[23px] text-[#7780A1]">
                                    Create a positive user experience, upgrade your apps on the go, and extend the <br></br>lifetime of your IT infrastructure with full-scale IT support and maintenance services.
                                </p>
                            ...
                            >
                                <img src="/assets/images/SERVER-MAINTENANCE.png" alt="services-detail-phone" className="mx-auto h-full" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-14 lg:py-[100px]">
                <div className="container">
                    <div className="heading text-left  ltr:lg:text-center rtl:lg:text-left">
                        <h4>IT support & maintenance services for flawless operations</h4>
                        {/* <p className="mt-4 text-lg font-semibold">
                            We combine our team’s
                        </p> */}
                    </div>
                    <div className="grid gap-10 items-center sm:grid-cols-3 sm:gap-7 lg:grid-cols-2">
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                                <img src='assets/images/experience-icon.png' className='m-auto h-[65px]' alt='experience' />
                            </div>
                            {/* <h4 className="mb-4 text-[22px] font-extrabold text-black dark:text-white">Define</h4> */}
                            <p className="font-bold text-center text-left m-auto w-[50%] leading-[32px] md:text-lg">
                                <b className='font-exterbold text-black'>Experience: </b>A support and maintenance services provider with a decade of experience, ITRex has established efficient workflows and gained expertise solving the most complex incidents. We are now eager to share our experience and take on new challenges
                            </p>
                        </div>
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                                <img src='assets/images/effectiveness-icon.png' className='h-[65px] m-auto' alt='effectiveness' />
                            </div>
                            {/* <h4 className="mb-4 text-[22px] font-extrabold text-black dark:text-white">Design</h4> */}
                            <p className="font-semibold text-center  m-auto w-[50%] leading-[32px] md:text-lg">
                                <b className='font-exterbold text-black'>Effectiveness:</b> Before diving into your project and actually delivering support and maintenance, we set clear service level objectives and determine measurable KPIs that guarantee the high quality of the delivered services
                            </p>
                        </div>
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                                <img src='assets/images/flexibility-icon.png' className='h-[65px] m-auto' alt='flexibility' />
                            </div>
                            {/* <h4 className="mb-4 text-[22px] font-extrabold text-black dark:text-white">Build</h4> */}
                            <p className="font-semibold text-center m-auto w-[50%] leading-[32px] md:text-lg">
                                <b className='font-exterbold text-black'>Flexibility:</b> We scale support teams according to the complexity of your project and offer a variety of engagement models that can be further adjusted to your specific business needs.
                            </p>
                        </div>
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                                <img src='assets/images/transparency-icon.png' className='h-[65px] m-auto' alt='transparency' />
                            </div>
                            {/* <h4 className="mb-4 text-[22px] font-extrabold text-black dark:text-white">Test</h4> */}
                            <p className="font-semibold text-center leading-[32px]  m-auto w-[50%] md:text-lg">
                                <b className='font-exterbold text-black'>Transparency:</b> We provide regular reporting to make sure our collaboration is transparent and built on trust. Some of the reports we deliver include service level, incident and root cause analysis, health check, and security reports
                            </p>
                        </div>
                    </div>
                </div>
...
export default Servicesdetailservmag;
