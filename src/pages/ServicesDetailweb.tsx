        ...
        <div>
                    ...
                    <div className="container">
                        <div className="relative items-center py-14 lg:flex lg:py-[100px]">
                            <div className="relative z-[1] text-center text-white lg:w-3/5 ltr:lg:text-left rtl:lg:text-right xl:w-3/5">
                                <h2 className="text-4xl font-black sm:text-5xl sm:leading-[126px] xl:text-[70px]">Web Development</h2>
                            ...
                            >
                                <img src="/assets/images/Ui-Ux-Design1.png" alt="services-detail-phone" className="mx-auto h-full" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-14 lg:py-[100px]">
                <div className="container">
                    ...
                    <div className="grid gap-10 sm:grid-cols-2 sm:gap-7 text-center lg:grid-cols-3">
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                                <svg width="65" style={{ margin: "auto" }} height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <h4 className="mb-4 text-[22px] font-extrabold text-black dark:text-white">
                                Custom Web Applications</h4>
                            <p className="font-semibold leading-[32px] md:text-lg">
                                At Codebeans our development teams build high performance web portals that create a seamless user experience to enable clients to connect with their target market. The end product comes from collaboration between our highly creative design team and our customers.
                            </p>
                        </div>
                        <div>
                            <div className="h-[100px]" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <h4 className="mb-4 text-[22px] font-extrabold text-black dark:text-white">Enterprise Software</h4>
                            <p className="font-semibold leading-[32px] md:text-lg">
                        ...
                        <div>
                            ...
                            <h4 className="mb-4 text-[22px] font-extrabold text-black dark:text-white">Website</h4>
                            <p className="font-semibold leading-[32px] md:text-lg">
            ...
            <section className="py-14 lg:py-[100px]">
                <div className="container items-center justify-center">
                    ...
                    <Marquee
                        speed={40}
                    >
                        <div className='mx-[42px] w-[70px]'>
                            <img src='assets/images/javascript.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[42px] w-[70px]'>
                            <img src='assets/images/knockout.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[42px] w-[70px]'>
                            <img src='assets/images/micrisoft-net.png' alt='brand-Logo' />
                        </div>
                        <div className='mx-[42px] w-[70px]'>
...
export default Servicesdetailweb;
