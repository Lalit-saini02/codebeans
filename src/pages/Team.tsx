...
const Team = () => {
    document.title = 'Team | Web App Development Company';
            ...
            <section className="relative overflow-hidden pt-14 lg:pb-48 lg:pt-[100px]">
                <div className="container relative z-[1]">
                    <div className="text-center lg:w-1/2 ltr:lg:text-left rtl:lg:text-right">
                        ...
                        <Link to="/career" className="btn capitalize text-white">
                            Request A Quote
                        </Link>
                    </div>
                </div>
                <img src="/assets/images/about-bg.png" alt="About" className="-bottom-5 ltr:right-0 rtl:left-0 rtl:rotate-y-180 lg:absolute" />
            </section>
